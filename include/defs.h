...
#define CUSTOM_FN_CTX "CHUNK_FUZZER_CUSTOM_FN_CONTEXT"
#define GEN_ID_RANDOM_VAR "CHUNK_FUZZER_GEN_ID_RANDOM"
#define OUTPUT_COND_LOC_VAR "CHUNK_FUZZER_OUTPUT_COND_LOC"
#define TAINT_CUSTOM_RULE_VAR "CHUNK_FUZZER_TAINT_CUSTOM_RULE"
#define TAINT_RULE_LIST_VAR "CHUNK_FUZZER_TAINT_RULE_LIST"
#define FUZZING_INPUT_FILE "cur_input"
#define PERSIST_ENV_VAR "CHUNK_FUZZER_PERSISTENT"
#define DEFER_ENV_VAR "CHUNK_FUZZER_DEFER_FORKSRV"
#define PERSIST_SIG "##SIG_CHUNK_FUZZER_PERSISTENT##"
#define DEFER_SIG "##SIG_CHUNK_FUZZER_DEFER_FORKSRV##"
